// Version definitive du parser, en utilisant une pile 
// pour comparer les types du/des switch et du/des cases contenus

// Switch à partir de ligne 414
...
case:
	"case" 	 expr ':' stms  	{ stk.push(new SwitchStack($2,@2,1)); } 
	| "case" expr ':' stms case { stk.push(new SwitchStack($2,@2,stk.peek().count + 1)); }
